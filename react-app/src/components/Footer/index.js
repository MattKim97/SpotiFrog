...
export default function Footer() {
  return (
    ...
    <div className="FooterStyle">The repo for our frogtastic site can be found here! <a href="https://github.com/MattKim97/SpotiFrog"> <i class="fa-brands fa-github"></i></a></div>
    </>
  );
}
