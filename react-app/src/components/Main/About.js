...
export default function About() {
  return (
    <div className='aboutContainer'>
      ...
      <p>
      Once upon a lily pad in the heart of the Enchanted Swamp, there lived a small green frog named Croakington. Unlike his fellow amphibians, Croakington harbored a passion that set him apart – he dreamed of becoming a bard, weaving melodies as enchanting as the moonlight dancing on the water.
      ...
      <p>
      Thus, we were inspired to create this site in order to share the melodies of all frogs around the world.
      </p>
    </div>
  )
}
